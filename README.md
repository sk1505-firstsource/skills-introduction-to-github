...
## Julian Day application

This repository now includes a small Python application that prints the Julian Day Number for a given date.

### Usage

```bash
python julian_day.py 2026-06-13
```
